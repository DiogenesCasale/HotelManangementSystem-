...
<h1 class="text-xl font-semibold mt-4 text-black dark:text-white">Quartos</h1>
...
<div class="flex items-center mt-2">
  ...
  <x-buttons.indigo class="text-sm w-32 ml-auto" id="create-bedroom-button">Cadastrar</x-buttons.indigo>
</div>

<x-tables.table headerComponent="tables.bedrooms.header" rowComponent="tables.bedrooms.row" class="mt-4" id="table" />

<x-modal.overlay id="overlay" class="hidden" />
<x-modal.modal-sidebar-right id="filter-modal" class="hidden" title="Filtros" description="Filtre de forma mais eficiente">
...
<x-modal.modal class="hidden w-7xl" id="bedroom-modal" title="Cadastrar quarto" description="Preencha os campos para cadastrar um novo quarto">
  <x-forms.bedroom/>
</x-modal.modal>
...
@section("scripts")
@vite("resources/js/pages/bedrooms/index.js")
@endsection