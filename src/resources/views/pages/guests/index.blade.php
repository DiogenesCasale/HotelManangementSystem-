...
<h1 class="text-xl font-semibold mt-4 text-black dark:text-white">Hóspedes</h1>
...
<div class="flex items-center mt-2">
  ...
  <x-buttons.indigo class="text-sm w-32 ml-auto" id="create-guest-button">Cadastrar</x-buttons.indigo>
</div>

<x-tables.table headerComponent="tables.guests.header" rowComponent="tables.guests.row" class="mt-4" id="table" />
...
<x-modal.modal class="hidden w-4xl" id="guest-modal" title="Cadastrar hóspede" description="Preencha os campos para cadastrar um novo hóspede">
  <x-forms.guest/>
</x-modal.modal>
...
@section("scripts")
@vite("resources/js/pages/guests/index.js")
@endsection