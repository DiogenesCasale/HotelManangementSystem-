...
<h1 class="text-xl font-semibold mt-4 text-black dark:text-white">Usuários</h1>
...
<div class="flex items-center mt-2">
  ...
  <x-buttons.indigo class="text-sm w-32 ml-auto" id="create-user-button">Cadastrar</x-buttons.indigo>
</div>

<x-tables.table headerComponent="tables.users.header" rowComponent="tables.users.row" class="mt-4" id="table" />
...
<x-modal.modal class="hidden w-4xl" id="user-modal" title="Cadastrar usuário" description="Preencha os campos para cadastrar um usuário">
  <x-forms.user/>
</x-modal.modal>
